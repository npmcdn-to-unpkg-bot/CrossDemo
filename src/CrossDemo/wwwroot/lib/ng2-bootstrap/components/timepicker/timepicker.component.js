...
define(["require", "exports", 'angular2/core', 'angular2/common'], function (require, exports, core_1, common_1) {
    ...
    var Timepicker = (function () {
        ...
        __decorate([
            core_1.Input()
        ], Timepicker.prototype, "hourStep");
        __decorate([
            core_1.Input()
        ], Timepicker.prototype, "minuteStep");
        __decorate([
            core_1.Input()
        ], Timepicker.prototype, "readonlyInput");
        __decorate([
            core_1.Input()
        ], Timepicker.prototype, "mousewheel");
        __decorate([
            core_1.Input()
        ], Timepicker.prototype, "arrowkeys");
        __decorate([
            core_1.Input()
        ], Timepicker.prototype, "showSpinners");
        __decorate([
            core_1.Input()
        ...
        __decorate([
            core_1.Input()
        ], Timepicker.prototype, "meridians");
        Object.defineProperty(Timepicker.prototype, "showMeridian",
            __decorate([
                // ??
                core_1.Input()
            ], Timepicker.prototype, "showMeridian", Object.getOwnPropertyDescriptor(Timepicker.prototype, "showMeridian")));
